...
def initialize_database(app):
    ...
    if False:
        # Create sample users
        admin_user = User(username='asilva', password='1234',badge_id='0',is_admin='1')
        # engineer_user = User(username='engineer', password='eng123',badge_id='1')
        # operator_user = User(username='operator', password='op123',badge_id='2')
